...
DROP TABLE IF EXISTS EF_simulation_prets;
...
CREATE TABLE EF_simulation_prets
(
    id                       INT PRIMARY KEY AUTO_INCREMENT,
    montant_pret             DECIMAL(12, 2) NOT NULL,
    durre_remboursement_mois INT            NOT NULL,
    montant_echeance         DECIMAL(12, 2) NOT NULL,
    durre_pret               INT            NOT NULL,
    taux_interet_annuel      DECIMAL(5, 2)  NOT NULL,
    taux_assurance_annuel    DECIMAL(5, 2) DEFAULT 0,
    date_debut_pret          DATE           NOT NULL,
    delai_remboursement_mois INT            NOT NULL
);
