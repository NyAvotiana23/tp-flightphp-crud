        ...
        <section class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                    <tr class="border-t">
                        <td class="py-2 text-base">Dépôt</td>
                        <td class="py-2 text-custom-sm">Enregistrement d'un dépôt client</td>
                        <td class="py-2">
                            <button class="text-custom-purple-primary hover:underline mr-2">Modifier</button>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                    <tr class="border-t">
                        <td class="py-2 text-base">Contrat d'Investissement</td>
                        <td class="py-2 text-custom-sm">Contrat pour investissement à long terme</td>
                        <td class="py-2">
                            <button class="text-custom-purple-primary hover:underline mr-2">Modifier</button>
                            <button class="text-red-600 hover:underline">Supprimer</button>
                        </td>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                    <tr class="border-t">
                        <td class="py-2 text-base">Transfert Interne</td>
                        <td class="py-2">
                            <button class="text-custom-purple-primary hover:underline mr-2">Modifier</button>
                            <button class="text-red-600 hover:underline">Supprimer</button>
                        </td>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="space-y-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                    <tr class="border-t">
                        <td class="py-2 text-base">Mensuel</td>
                        <td class="py-2 text-custom-sm">12</td>
                        <td class="py-2">
                            <button class="text-custom-purple-primary hover:underline mr-2">Modifier</button>
                            <button class="text-red-600 hover:underline">Supprimer</button>
                        </td>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md lg:col-span-2">
            ...
            <div class="space-y-4">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                    <tr class="border-t">
                        <td class="py-2 text-base">Prêt Immobilier</td>
                        <td class="py-2 text-custom-sm">2.5</td>
                        <td class="py-2 text-custom-sm">4.0</td>
                        <td class="py-2 text-custom-sm">Achat de propriété résidentielle</td>
                        <td class="py-2">
                            <button class="text-custom-purple-primary hover:underline mr-2">Modifier</button>
                            <button class="text-red-600 hover:underline">Supprimer</button>
                        </td>
