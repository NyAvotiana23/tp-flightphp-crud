...
<!-- Barre de navigation -->
<nav id="navbar" class="fixed top-0 left-0 right-0 bg-custom-purple-primary text-white shadow-lg transition-transform duration-300 ease-in-out z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <h1 class="text-h5 font-bold">Administration Financière</h1>
        <ul class="flex space-x-6">
            <li><a href="#" class="hover:text-custom-purple-secondary text-base">Tableau de bord</a></li>
