    ...
    <div class="max-w-md mx-auto mb-12 bg-white rounded-lg shadow-lg p-6">
        ...
        <form onsubmit="onSubmitCreateClient(event)">
            <div class="mb-4">
                ...
                <input type="text" id="newClientNumber" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez le numéro client" required>
            </div>
            <div class="mb-4">
                <label for="newPassword" class="block text-h6 font-medium mb-2">Mot de passe</label>
                <input type="password" id="newPassword" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez le mot de passe" required>
            </div>
            <div class="mb-4">
                <label for="newLastName" class="block text-h6 font-medium mb-2">Nom</label>
                <input type="text" id="newLastName" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez le nom" required>
            </div>
            <div class="mb-4">
                <label for="newFirstName" class="block text-h6 font-medium mb-2">Prénom</label>
                <input type="text" id="newFirstName" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez le prénom" required>
            </div>
            <div class="mb-4">
                <label for="newDOB" class="block text-h6 font-medium mb-2">Date de Naissance</label>
                <input type="date" id="newDOB" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" required>
            </div>
            <div class="mb-4">
                <label for="newEmail" class="block text-h6 font-medium mb-2">Email</label>
                <input type="email" id="newEmail" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez l'email" required>
            </div>
            <div class="mb-4">
                <label for="newAddress" class="block text-h6 font-medium mb-2">Adresse</label>
                <input type="text" id="newAddress" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez l'adresse">
            </div>
            <div class="mb-6">
                <label for="newTelephone" class="block text-h6 font-medium mb-2">Téléphone</label>
                <input type="tel" id="newTelephone" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez le numéro de téléphone">
            </div>
            <button type="submit" class="w-full bg-custom-purple-primary text-white py-2 rounded-lg hover:bg-custom-purple-secondary transition duration-300">Créer Client</button>
        </form>
    </div>
    ...
    <div class="max-w-md mx-auto mb-12 bg-white rounded-lg shadow-lg p-6">
        ...
        <form onsubmit="onSubmitClient(event)">
            <div class="mb-4">
                ...
                <input type="text" id="clientNumber" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez votre numéro client" required>
            </div>
            <div class="mb-6">
                <label for="password" class="block text-h6 font-medium mb-2">Mot de passe</label>
                <input type="password" id="password" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Entrez votre mot de passe" required>
            </div>
            ...
            <div class="mt-6">
                ...
                <form onsubmit="onSubmitClient(event)">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" id="modalPassword" class="w-full p-2 border border-custom-purple-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-custom-purple-primary" placeholder="Mot de passe" required>
                    </div>
                    <button type="submit" class="w-full bg-custom-purple-primary text-white py-2 rounded-lg hover:bg-custom-purple-secondary transition duration-300">Se connecter</button>
                </form>
            </div>
